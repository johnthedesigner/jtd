            ...
            <div id="contact" className="home-contact">
                ...
                <div className="email-block">
                    <input
                        ...
                        style={{
                            borderColor: showCopySuccess
                                ? palettes['caribbean-green'][5].value
                                : palettes['navy-blue'][5].value,
                            borderWidth: '2px',
                    ...
                    <button
                        ...
                        onClick={copyEmail}
                        style={{
                            background: showCopySuccess ? palettes['caribbean-green'][5].value : palettes['navy-blue'][5].value,
                ...
                >
                    <g clipPath="url(#clip0_201_786)">
                        <path
                            ...
                            fill={palettes['caribbean-green'][3].value}
                        />
                        <path
