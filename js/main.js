$(document).ready(function(){
	...
	// Add email to page
	var email = "john@johnthedesigner.com";
	var href = "mailto:" + email;
	$('#email-link').attr('href', href).append(email);

	// Vertically center slider nav
	function verticalAlignElement(){
		$.each($('.vertical-align'),function(){
	...
	// Parallax Scroll Feature (Exclude mobile)
	if(!mobilecheck()){
