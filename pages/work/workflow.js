        ...
        <Layout>
            <div id="main">
                ...
                <div className="work__copy">
                    ...
                    <p>
                        Our flagship application once allowed users to analyze
                        their projects with a single, powerful analysis feature.
                        But after one nine-month stretch of work in 2018 we
                        found ourselves with 5 separate tools for analyzing a
                        project. Our original designs for these tools share
                        consistent layout, style and interactions, but over time
                        we found that this framework worked better for some
                        tools than for others. In subtle ways, the tools began
                        to grow apart.
                    </p>
                    ...
                    <p>
                        ...
                        , analyze feedback for a certain demographic or they can
                        choose a set of concepts to study. These are the common
                        elements that make up our new framework
                    </p>
                    <p>
                ...
                <div className="work__art-container">
                    <div className="figma-iframe--large">
                        ...
                        <h4 className="work__art-caption">
                            Some elements and features are consistent from tool
                            to tool. These are the elements of our analysis tool
                            framework
                        </h4>
                    </div>
                </div>
                <div className="work__art-container">
                    <div className="figma-iframe--large">
                        ...
                        ></iframe>
                        <h4 className="work__art-caption">
                            Examples of designing with this framework, using the
                            Drivers tool
                        </h4>
                    </div>
                </div>
                <div className="work__copy">
                    <h3>How did we approach this design?</h3>
                    <p>
                        This project is still in progress. One of our biggest
                        challenges with updates like this that touch so many
                        parts of the UI is finding the right order of execution.
                        We are developing a broad cross section of these
                        updates, starting with a single tool. In this way we
                        will be able to get user feedback earlier, and have a
                        clear path to impementing these updates in each of our
                        other tools once we have worked out the kinks
                    </p>
                </div>
            </div>
        </Layout>
