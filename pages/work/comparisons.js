            ...
            <div id="main">
                ...
                <div className="work__copy">
                    ...
                    <p>
                        ...
                        feature, and to cover all of our bases required sharing
                        the design early and incorporating a number of rounds of
                        feedback. This feature was largely shaped on the
                        whiteboard, in meetings with stakeholders from product
                        management and engineering and with regular users of the
                        product.
                    </p>
                    <p>
                        ...
                        about what date ranges they were seeing.
                    </p>
                </div>
                <div className="work__art-container">
                    <div className="figma-iframe--small">
                        ...
                        <h4 className="work__art-caption">
                            A scatterplot visualization from the Drivers tool,
                            showing the current date range with out a comparison
                            view
                        </h4>
                    </div>
                    <div className="figma-iframe--small">
                        ...
                        <h4 className="work__art-caption">
                            A scatterplot visualization from the Drivers tool,
                            showing the current date range being compared to the
                            previous period
                        </h4>
                    </div>
                </div>
                <div className="work__art-container">
                    <div className="figma-iframe--large">
                        ...
                        ></iframe>
                        <h4 className="work__art-caption">
                            Full-page mockup of the Drivers tool, showing views
                            without a comparison, with a comparison, and while
                            curating the concepts to be visualized in the
                            scatterplot
                        </h4>
                    </div>
                </div>
